...
def arg_parser():
    ...
    parser.add_argument('--top_k1', type=int, default=3, help='top_k1')
    parser.add_argument('--top_k2', type=int, default=4, help='top_k2')
    parser.add_argument('--sample_high_rate', type=float, default=0.1, help='sample_high_rate')
    parser.add_argument('--warm_up', type=int, default=40, help='warm_up.')
    parser.add_argument('--temperature', type=float, default=0.5, help='conloss temperature')
    parser.add_argument('--alpha_P', type=float, default=0.8, help='alpha_P')
    parser.add_argument('--beta', type=float, default=0.2, help='loss_ce_beta')
    parser.add_argument('--gamma', type=float, default=1, help='loss_con')
